    ...
    (function($, window, document, undefined) {
        ...
        function _fnCalculateColumnWidths(oSettings) {
            var
                ...
                tableWidthAttr = '100%', // table.getAttribute('width'), // from DOM element
        ...
        DataTable.defaults = {
             ...
             */
         //   "sDom": "lfrtip",
            "sDom": "frtilp",  // May 2018.11.13 l:Length changing(變更頁數),改至表尾i(Information)後面
